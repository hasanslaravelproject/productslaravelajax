...
class SubCategoryControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_sub_categories()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_sub_category()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_sub_category()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_sub_category()
    {
        $subCategory = SubCategory::factory()->create();
    ...
    public function it_deletes_the_sub_category()
    {
        ...
        $this->assertDeleted($subCategory);
    }
}
